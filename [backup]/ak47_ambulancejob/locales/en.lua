Locales['en'] = {
    ...
    gavefirstaid = "First aid has been given, your wounds are healing...",
    tookmedkit = "You took a med kit, your wounds are healing...",
    gavemedkit = "Medikit has been given, your wounds are healing...",
    ...
    givefarstaid  = "Give Farstaid",
    givemedikit  = "Give Medikit",
