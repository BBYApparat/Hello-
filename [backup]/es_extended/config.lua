...
Config.StartingAccountMoney = { bank = 5000, money = 4000 }

Config.StarterItems = {
}

Config.MaxInvSlots = 41
Config.MaxWeight = 150000
Config.UseUIforIDCard = true -- This enables a UI for ID Card build in Salty inventory
...
Config.BlacklistedNotificationItems = {
    ["pistol_ammo"] = true,
    ["smg_ammo"] = true,
    ["shotgun_ammo"] = true,
    ["rifle_ammo"] = true,
