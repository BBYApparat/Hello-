Config = Config or {}
Config.Inventory = "inventory" -- false it will auto detect your inventory, or set manually your inventory name "qb-inventory", "ox_inventory", etc.
...
Config.InventoryPath = {
    ...
    ['inventory'] = "inventory/html/images/",
...
CreateThread(function()
    ...
    if GetResourceState("inventory") ~= "missing" then
