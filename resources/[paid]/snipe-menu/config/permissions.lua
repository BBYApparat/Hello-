...
Config.Permissions = {
    ["steam:1100001413ee43d"] = "god", -- the role god, admin or mod should be the key from Config.GodRoles which means the values that are added in square brackets.
    ["char1:steam:1100001413ee43d"] = "god",
    ["steam:1234"] = "god",
