...
elseif Config.Inventory == 'qs' then
    ...
    QBCore.Functions.CreateUseableItem(Config.Items["wateringcan"], function(source, item)
        TriggerClientEvent('rep-weed:client:fillWater', source, item)
    end)

    QBCore.Functions.CreateUseableItem(Config.Items["femaleseed"], function(source, item)
        TriggerClientEvent('rep-weed:client:plantWeed', source, item)
    end)

    QBCore.Functions.CreateUseableItem(Config.Items["driedbud"], function(source, item)
        TriggerClientEvent('rep-weed:client:rollJoint', source, item)
    end)

    QBCore.Functions.CreateUseableItem(Config.Items["weedbaggie"], function(source, item)
        TriggerClientEvent('rep-weed:client:rollJoint', source, item)
    end)

    QBCore.Functions.CreateUseableItem(Config.Items["weedpackage"], function(source, item)
        TriggerClientEvent('rep-weed:client:prepareBaggies', source, item)
    end)

    QBCore.Functions.CreateUseableItem(Config.Items["joint"], function(source, item)
        if Framework.RemoveItem(source, item.name, 1, item.slot) then
            TriggerClientEvent('rep-weed:client:smokeWeed', source, item)
            local info = {}
            info.n = item.info.n or 0
