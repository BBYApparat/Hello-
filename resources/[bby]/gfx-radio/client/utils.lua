...
function LoadParticleFxAsset(asset)
...
function DrawScreenText(x, y, text)
...
function DrawCursorText(text)
  ...
  SetTextCentre(1)
  AddTextComponentString(text)
  local posX = GetDisabledControlNormal(0, 239)
  local posY = GetDisabledControlNormal(0, 240) - 0.025
  DrawText(posX, posY)
end
