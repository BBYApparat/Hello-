...
Config.PoliceStations = {
	["station_1"] = {
		...
		bossmenu = {
			pos = vector3(-569.999, -725.647, 41.441),
			min_grade = 4
		},
		duty = vector3(-0.083, -0.347, 0.258),
		zone = {
			pos = vector3(-589.083, -715.347, 36.258),
		...
		armory = {
			pedPos = vector3(0.681, -0.424, 0.441),
			playerPos = vector4(-591.3, -726.576, 41.441, 235.195),
			model = 's_m_y_cop_01',
		...
		garage = {
			['police_garage_1'] = {
				pedPos = vector4(-581.395, -707.738, 25.751, 90.378),
				model = 'mp_m_weapexp_01',
				spawn = vector4(-596.089, -712.332, 26.751, 269.816),
				deposit = vector3(-579.693, -712.719, 26.751),
				driverSpawnCoords = vector3(-596.089, -712.332, 25.751),
