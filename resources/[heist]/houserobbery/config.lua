...
Config.Items = { -- chance should be less than MaxChance and higher means hard to get
    ["Fridge"] = {
        ...
        {chance = 5, id = 'sprunk', qtyMin = 1, qtyMax = 2},
    },
    ["Drawers"] = {
        {chance = 10, id = 'scrap', qtyMin = 1, qtyMax = 1},
        {chance = 19, id = 'hack_usb', qtyMin = 1, qtyMax = 1},
        {chance = 19, id = 'black_card', qtyMin = 1, qtyMax = 1},
        {chance = 15, id = 'mysterious_white_card', qtyMin = 1, qtyMax = 1},
        {chance = 10, id = 'money', qtyMin = 50, qtyMax = 200},
    },
    ["Table"] = {
        {chance = 19, id = 'goldenwatch', qtyMin = 1, qtyMax = 2},
        {chance = 10, id = 'tost', qtyMin = 1, qtyMax = 1},
    },
    ["Storage"] = {
        {chance = 18, id = 'gold_ingot', qtyMin = 1, qtyMax = 1},
        {chance = 16, id = 'diamond', qtyMin = 1, qtyMax = 1},
        {chance = 16, id = 'ring', qtyMin = 1, qtyMax = 1},
        {chance = 10, id = 'goldchain', qtyMin = 1, qtyMax = 1},
        {chance = 8, id = 'sapphire', qtyMin = 1, qtyMax = 1},
        {chance = 8, id = 'emerald', qtyMin = 1, qtyMax = 1},
    },
    ["Wardrobe"] = {
        {chance = 16, id = 'diamond', qtyMin = 1, qtyMax = 1},
        {chance = 16, id = 'ring', qtyMin = 1, qtyMax = 1},
        {chance = 12, id = 'emerald_ring_gold', qtyMin = 1, qtyMax = 1},
        {chance = 12, id = 'emerald_ring_silver', qtyMin = 1, qtyMax = 1},
        {chance = 12, id = 'sapphire_ring_silver', qtyMin = 1, qtyMax = 1},
        {chance = 12, id = 'sapphire_ring_gold', qtyMin = 1, qtyMax = 1},
    },
    ["Jewelry"] = {
        {chance = 18, id = 'gold_ingot', qtyMin = 1, qtyMax = 1},
        {chance = 19, id = 'goldchain', qtyMin = 1, qtyMax = 1},
        {chance = 15, id = 'gold_ring', qtyMin = 1, qtyMax = 2},
    },
    ["Under Bed"] = {
        {chance = 19, id = 'hack_usb', qtyMin = 1, qtyMax = 1},
        {chance = 19, id = 'black_card', qtyMin = 1, qtyMax = 1},
        {chance = 10, id = 'money', qtyMin = 100, qtyMax = 500},
    },
    ["Cupboards"] = {
        {chance = 19, id = 'hack_usb', qtyMin = 1, qtyMax = 1},
        {chance = 19, id = 'black_card', qtyMin = 1, qtyMax = 1},
        {chance = 15, id = 'whiskey', qtyMin = 1, qtyMax = 1},
        {chance = 15, id = 'vodka', qtyMin = 1, qtyMax = 1},
        {chance = 15, id = 'tequila', qtyMin = 1, qtyMax = 1},
    },
    ["Cabinet"] = {
        {chance = 19, id = 'goldchain', qtyMin = 1, qtyMax = 1},
        {chance = 2, id = 'black_usb', qtyMin = 3, qtyMax = 5},
    ...
    ["Coffee Table"] = {
        {chance = 1, id = 'mysterious_white_card', qtyMin = 1, qtyMax = 1},
        {chance = 10, id = 'money', qtyMin = 10, qtyMax = 100},
    },
}
...
Config.RobOffset = {
    ...
    [6] = {x = 8.46626300, y = 4.53223600, z = 1.29425800, name = "Wardrobe", isSearched = false},
    [7] = {x = 5.84416200, y = 2.57377400, z = 1.22089100, name = "Table", isSearched = false},
    [8] = {x = 3.04164100, y = 0.31671810, z = 3.48363900, name = "Jewelry", isSearched = false},
    ...
    [11] = {x = -5.53120400, y = 0.76299670, z = 1.57236000, name = "Cabinet", isSearched = false},
