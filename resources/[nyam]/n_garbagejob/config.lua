...
Config.Items = {
    onCompleteDumpster = true, -- Each time you collect the (X) amounnt of bags out of a dumpster (you can keep both)
    onCompleteDumpsterMaxItems = 2,
    onCompleteRoute = false, -- On the end , with your payslip (You can keep both)
    onCompleteRouteMaxItems = 10,
    rewards = {
        {name = "plastic", amount = {min = 1, max = 3}},
        {name = "rubber", amount = {min = 1, max = 3}},
        {name = "scrap", amount = {min = 1, max = 3}},
        {name = "brokenglasses", amount = {min = 1, max = 3}},
        {name = "brokenpendrive", amount = {min = 1, max = 3}},
        {name = "brokenphone", amount = {min = 1, max = 3}},
        {name = "glass", amount = {min = 1, max = 3}},
        {name = "scrapelectronics", amount = {min = 1, max = 3}},
    }
}
