Translations = {
    en = {
        error = {
            ...
            ["no_vehicle_plate"] = "You're not in the same Cab Taxi you rented",
            ["not_active_meter"] = "The Taxi Meter Is Not Active",
            ["no_meter_sight"] = "No Taxi Meter In Sight",
            ["already_rented"] = "You already have rented a taxi Cab :)",
            ["time_ran_out"] = "Time Ran out, client got disappointed and force you to stop the vehicle"
        },
        success = {},
        info = {
            ...
            ["waiting_for_client"] = "Waiting for a client",
            ["mission_canceled"] = "Client discarded"
        },
        menu = {
