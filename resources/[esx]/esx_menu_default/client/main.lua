...
local Keys = {
    ...
    ["~"] = 243, ["1"] = 157, ["2"] = 158, ["3"] = 160, ["4"] = 164, ["5"] = 165, ["6"] = 159, ["7"] = 161, ["8"] = 162, ["9"] = 163, ["-"] = 84, ["="] = 83, ["BACKSPACE"] = 202,
    ["TAB"] = 37, ["Q"] = 44, ["W"] = 32, ["E"] = 38, ["R"] = 45, ["T"] = 245, ["Y"] = 246, ["U"] = 303, ["P"] = 199, ["["] = 39, ["]"] = 40, ["ENTER"] = 201,
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if #ESX.UI.Menu.GetOpenedMenus() > 0 then
                if IsControlJustReleased(0, Keys['ENTER']) and GetLastInputMethod(2) then
                    SendNUIMessage({
                ...
                if IsControlJustReleased(0, Keys['BACKSPACE']) and GetLastInputMethod(2) then
                    SendNUIMessage({
                        action = 'controlPressed',
                        control = 'BACKSPACE'
                    })
