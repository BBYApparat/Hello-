...
Config.VATPercentage = 15 -- Visual only, it won't influence the final invoice value, change it to your country VAT value

Config.LimitDate = true -- Used to enable/disable whether we want to have the payment limit date or not

Config.LimitDateDays = 7 -- If Config.LimitDate is enabled, it is used to define the days of the deadline for payment after issuing the invoice
...
Config.BotName = 'Billing' -- Write the desired bot name

Config.ServerName = 'ESX Legacy V3' -- Write your server's name

Config.IconURL = nil -- Insert your desired image link
