...
Config.inventoryDirectory = 'ox_inventory/html/images/'

Config.debug = false -- if true it'll print some debug on F8/console and active all zones debug

Config.useOxInventoryCraft = false -- if true it'll use the ox_inventory crafting system on all crafts (only for ox_invntory, check docs for that)
