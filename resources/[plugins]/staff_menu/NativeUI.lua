...
BadgeColour = {
    [5] = function(Selected) if Selected then return 255, 0, 0, 255 else return 255, 255, 255, 255 end end,
    [21] = function(Selected) if Selected then return 255, 0, 0, 255 else return 255, 255, 255, 255 end end,
    [22] = function(Selected) if Selected then return 255, 0, 0, 255 else return 255, 255, 255, 255   end end,
}
