...
const openIdCard = (playerData) => {
  ...
  if ( playerData.licenses == null) {
    // document.getElementById('licenses_div').style.display = 'none';
    document.getElementById('lang_lic').style.display = 'none';
    document.getElementById('licenses').style.display = 'none';
  } else {
    // document.getElementById('licenses_div').style.display = 'block';
    document.getElementById('lang_lic').style.display = 'block';
